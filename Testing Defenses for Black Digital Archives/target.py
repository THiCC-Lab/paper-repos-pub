...
#Start the HTML File
to_html = ["<!DOCTYPE html>","<html>","<head>","<link rel='stylesheet' href='target.css'/>",
           "<title>","Testing CCP","</title>","</head>"]

#Character Overload
character_amount = 155555
step = 0
...
while step < character_amount:
        ...
        step += 1
        if step % 50 == 0:
             to_html.append('<p class="character">. The LOREM IPSUM. </p>')
